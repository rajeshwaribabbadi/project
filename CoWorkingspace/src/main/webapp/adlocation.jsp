...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1" import="java.sql.*,com.space.db.SpaceDBUtil"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>Add Locaion</title>
	...
	<script type="text/javascript">
          ...
          function myfun(){
        	  ...
        	  if(a.test(lname)){
        		  ...
        		  document.getElementById("locationname").innerHTML="**please enter only char";
        		  return false;
        	  }
          }
  ...
  <a href="./adreservation.jsp">User Reservation</a>
   ...
   <div class="container">
	<center>
		...
		<form action="addlocation" method="post" onsubmit="return myfun()">
			<table align="center">
				<div class="form-group">
					<tr>
						<td>Location Name</td>
						<td><input type="text" name="locationname" id="lname" class="form-control" />
	...
	<div class="ListOfLocations">
		...
		<table align="center" border="1">
			...
			<tr>
				...
				<td><a
					href="./adupdatelocation.jsp?locationid=<%=rs.getInt(1)%>">Update</a></td>
				<td><a href="./deletelocation?locationid=<%=rs.getInt(1)%>">Delete</a></td>
			</tr>
			<%
				}
			%>
