...
<html>
<head>
	<title>ChennaiPage</title>
	<link rel="stylesheet" type="text/css" href="chennai.css">
...
<body>
	<div class="banner">
	    ...
	    <div id="info">
			ContactUS:   <span><i class="fa fa-phone"></i> &nbsp; 1800 000 000</span>
	...
	<div class="map">
		<div id="he">
			<h2>Our Branches in Chennai</h2>
		</div>
		<iframe src="https://www.google.com.qa/maps/d/u/0/embed?mid=1gmLQ9d1E74WGRgEF4NYXnEx5g5Jx3CzD" width="640" height="300"></iframe>
	</div>
	<%
	...
	<div class="fo">
		<h2>About WorkingSpace in Chennai</h2>
		<b>A few Workafacts exclusively for you!</b>
<br>
<p>Choose WorkSpace4U potpourri of benefits for you.OurCoworking space in Chennai offers you</p>
<br>
<b>Coworking space in Chennai</b>
<br>
<p>Our office space in Chennai is spread across the city. With multiple centres around, you have the luxury of choosing the location that’s most preferred for you.
</p>
<br>
<b>Affordability and flexibility</b>
<br>
<p>Are you an entrepreneur looking out for a professional space? Are you looking to grow your team? Whether you have a requirement for a single seat or for a whole office, we have it for you. Add as you scale, customise your office space, hot desk from any Workafella location of your choice.</p>
<br>
<b>Amenities and Lifestyle benefits</b>
<p>Our Coworking space in Chennai provides unlimited Wi-Fi, telephone calls, CCTV, security, unlimited tea/coffee, front desk, IT, HR, maintenance, utilities, food court, projectors and housekeeping.
As a value ad, we have kept traffic in mind hence providing valet parking services. For last minute help, we are facilitated with kettle, steam iron and shower. Workafella also provides you with runner boys who can come in handy throughout.</p>
<br>
<b>Events and Networking</b>
<br>
<p>Every business needs networking to grow and we enable that in the right way. By closely working with people from different fields, you’re also open for building new possibilities and explore new territories.
To add a streak of fun, we also conduct various events to lighten up the moment for all of us. We strongly believe that a little of fun can make our productivity better.</p>
<br>
<p>The best Coworking space in Chennai is here for you. Make the choice today.</p>
<br>
<b>Think workspace? WorkSpace4U it.</b>
	</div>
	<div class="footer">
